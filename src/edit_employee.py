...
def edit_employee(): 
    """Function allows user to select an employee to edit."""
...
def edit_employee_attributes(employee):
    """Allows user to edit the attributes of the selected employee.
       
    :param employee: The employee selected to edit attributes of.
    """
    # Check for a valid letter if input given.
    ...
    # If a new_name, new_age, new_role, or new_salary is input.
    if new_name != "":
