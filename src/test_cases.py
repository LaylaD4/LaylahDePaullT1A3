# Import to run testing.
import pytest

# Import to add inputs.
import builtins

# Import to add list of mocked inputs.
...
# age of employees listed in the employee_list. 

def test_calculate_avg_age_of_employees():
    """
    1) Test Case: check calculate_avg_age_of_employee function is working correctly
    by adding another instance of an Employee to the employee_list. Currently
    ...
    instance of an employee from employee_list."""
